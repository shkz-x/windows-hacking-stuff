...
#>
    ...
    PROCESS {
        ...
        if ($PSBoundParameters["Credential"]) {
            ...
            $ADSIObject = New-Object System.DirectoryServices.DirectoryEntry -ArgumentList $Object.adspath
        }
...
#>
    ...
    PROCESS {
        ...
        $returnValue = Set-DomainObjectProperty @arguments -SET @{"gplink" = $finalString} -ObjectType "OU" -OUIdentity $OUIdentity -Overwrite
    }
